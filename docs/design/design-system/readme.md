...
- **Headers**: gunmetal band, sticky, rounded bottom corners (24px); white large-title (30px, weight 800, display face), silver subtitle. The tab bar mirrors it (gunmetal frosted, rounded top corners, coral active / silver inactive) so dark chrome bookends the white canvas.
