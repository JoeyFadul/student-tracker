...
| 1.7 ✅ | Guided first-run | Shipped: 3-step OnboardingWizard (classroom → year → optional roster paste) → provisions via raw api + refresh → populated dashboard (doc 02 FR-NAV-5, doc 10 A3). Frontend-only |
