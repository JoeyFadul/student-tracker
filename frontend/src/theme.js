...
export const theme = {
  colors: {
    ...
    gunmetal: 'var(--wd-gunmetal)',
    gunmetalRaised: 'var(--wd-gunmetal-raised)',
    slate: 'var(--wd-slate)',
    slateSoft: 'var(--wd-slate-soft)',
    silver: 'var(--wd-silver)',
    onDark: 'var(--wd-on-dark)',
    onDarkMuted: 'var(--wd-on-dark-muted)',
    onDarkBorder: 'var(--wd-on-dark-border)',
    surfaceTranslucent: 'var(--wd-surface-translucent)',
    avatarBg: 'var(--wd-avatar-bg)',
    shimmerMid: 'var(--wd-shimmer-mid)',
  },
  radius: { sm: 8, md: 12, lg: 16, xl: 20, sheet: 24, pill: 999 },
  space: { xs: 4, sm: 8, md: 12, lg: 16, xl: 20, xxl: 24, xxxl: 32 },
  // Gunmetal-tinted ink shadows; the FAB alone gets a coral glow
  // (design-system tokens/shape.css).
  shadow: {
    sm: '0 1px 2px rgba(45, 49, 66, 0.06)',
    md: '0 2px 8px rgba(45, 49, 66, 0.08), 0 1px 2px rgba(45, 49, 66, 0.04)',
    lg: '0 10px 28px rgba(45, 49, 66, 0.14), 0 2px 6px rgba(45, 49, 66, 0.06)',
    sheet: '0 -8px 32px rgba(45, 49, 66, 0.18)',
    fab: '0 6px 20px rgba(239, 131, 84, 0.40)',
  },
  font: {
  ...
  // Bottom bars sink 8px into the safe area so their content sits optically
  // centered in the visible strip instead of riding high above the home
  // indicator; max() keeps it at 0 where there is no inset (web).
  safeBottomBar: 'max(calc(env(safe-area-inset-bottom) - 8px), 0px)',
};
